...
/// Lightweight, pre-sorted E.164 numerical entry prepared specifically for CallKit identification.
public struct CallKitIdentificationEntry: Codable, Sendable {
