...
public final class TGSubscriptionManager: ObservableObject {
    ...
    public func fetchProducts() async {
        do {
            ...
            print("Log: - [TGSubscriptionManager] Successfully fetched \(fetched.count) product(s) from StoreKit:")
            for product in fetched {
                print("Log: - [TGSubscriptionManager] -> Product ID: \(product.id) | Price: \(product.displayPrice) | Name: \(product.displayName)")
